 ...
 */
namespace TMA\SocialLogin\Helper;

use TMA\SocialLogin\Helper\Data as HelperData;

/**
 * Class Social
 * @package TMA\SocialLogin\Helper
 */
class Social extends HelperData
{
	...
	public function getSocialConfig($type)
	{
		$apiData = [
			...
			'Vkontakte' => ['wrapper' => ['class' => '\TMA\SocialLogin\Model\Providers\Vkontakte']],
			'Instagram' => ['wrapper' => ['class' => '\TMA\SocialLogin\Model\Providers\Instagram']],
			'Github'    => ['wrapper' => ['class' => '\TMA\SocialLogin\Model\Providers\GitHub']],
			'Amazon'    => ['wrapper' => ['class' => '\TMA\SocialLogin\Model\Providers\Amazon']]
		];
