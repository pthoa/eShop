...
*/
namespace TMA\SocialLogin\Model\Providers;
...
class Amazon extends \Hybrid_Provider_Model_OAuth2 {
	...
	function initialize() {
		...
		$this->api = \Magento\Framework\App\ObjectManager::getInstance()->create('TMA\SocialLogin\Model\Providers\Amazon', ['client_id' => $this->config['keys']['id'], 'client_secret' => $this->config['keys']['secret'], 'redirect_uri' => $this->endpoint, 'compressed' => $this->compressed]);
