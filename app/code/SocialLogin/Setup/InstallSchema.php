...
namespace TMA\SocialLogin\Setup;

/**
 * Class InstallSchema
 * @package TMA\SocialLogin\Setup
 */
class InstallSchema implements \Magento\Framework\Setup\InstallSchemaInterface
{
    ...
    public function install(\Magento\Framework\Setup\SchemaSetupInterface $setup, \Magento\Framework\Setup\ModuleContextInterface $context)
    {
        ...
        $setup->getConnection()->dropTable($setup->getTable('tma_social_customer'));

        $table = $installer->getConnection()->newTable(
            $installer->getTable('tma_social_customer')
        )
            ->addColumn(
            ...
            ->addColumn(
                ...
                $installer->getFkName('tma_social_customer', 'customer_id', 'customer_entity', 'entity_id'),
                'customer_id',
